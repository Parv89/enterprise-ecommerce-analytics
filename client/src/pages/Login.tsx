...
import { ShieldCheck, LogIn, Key, Mail, Lock } from 'lucide-react';
    ...
    <div className="max-w-md mx-auto my-12 space-y-6">
      ...
      <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-extrabold text-gray-900">Sign In to Platform</h1>
          <p className="text-xs text-gray-500">Access enterprise commerce dashboard & catalog.</p>
        </div>
        ...
        <div className="border-t border-gray-100 pt-4 space-y-2">
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className="py-1.5 px-2 bg-purple-50 hover:bg-purple-100 text-purple-700 rounded-lg text-xs font-bold border border-purple-200"
            >
              Admin
            </button>
            <button
              onClick={() => fillQuickLogin('manager@enterprise.com', 'Manager@123')}
              className="py-1.5 px-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-lg text-xs font-bold border border-indigo-200"
            >
              Manager
            </button>
            <button
              onClick={() => fillQuickLogin('customer@enterprise.com', 'Customer@123')}
              className="py-1.5 px-2 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-lg text-xs font-bold border border-blue-200"
            >
              Customer
            </button>
          </div>
